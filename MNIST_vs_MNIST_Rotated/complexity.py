...
def main():
    clfs = [SVC(), AdaBoostClassifier(), GaussianNB(), LogisticRegression(solver='sag', max_iter=256), DecisionTreeClassifier()]
    datasets = []
    experiments = []
    ...
    # datasets.append((make_gaussian_quantiles(n_samples=500, n_features=10, n_classes=3),make_gaussian_quantiles(n_samples=500, n_features=10, n_classes=3)))
